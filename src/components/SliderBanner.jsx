  ...
  return (
    <div className="flex flex-col h-full relative md:mx-16 lg:mx-16">
      ...
      <div className="relative mt-7 banner-div overflow-hidden flex justify-center slide-up transition-opacity duration-300">
        ...
        <div
          className="z-0 gap-x-0 gap-y-0 items-start  justify-start grid-rows-[auto_auto] bg-white rounded-[170px] grid-cols-[9fr_25fr_9fr] auto-cols-fr w-full min-h-full grid absolute inset-x-0"
          dir="ltr"
        >
           <img
            src={left}
